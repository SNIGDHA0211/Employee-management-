    ...
    <header className="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 sticky top-0 z-10 shadow-sm">
              ...
              {alerts.map((a) => {
                ...
                return (
                  <button
                    ...
                    className={`px-4 py-1.5 rounded-xl text-white text-base font-semibold cursor-pointer ${isCompleted ? 'alert-glow-green bg-green-500 border border-green-600 hover:bg-green-600' : 'alert-glow bg-red-500 border border-red-600 hover:bg-red-600'}`}
      ...
      <div className="flex items-center space-x-4">
        ...
        <button
          type="button"
          onClick={onPlusClick ?? (() => {})}
          className="flex items-center justify-center w-9 h-9 rounded-full bg-red-500/90 text-white hover:bg-red-600 transition-colors shrink-0 shadow-[0_0_12px_rgba(239,68,68,0.4)]"
        ...
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white">
            ...
            <g filter="url(#alert-glow)">
              <path d="M12 3L21 19H3L12 3Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
